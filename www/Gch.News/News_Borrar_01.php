...
function process_form(){
	...
	<form name='ver' action='News_Borrar_02.php' method='POST'>
...
function show_form($errors=''){
	...
	global $bnews;
	$bnews = "<form name='creanews' action='News_Modificar_01.php' style=\"display:inline-block;\">
					<input type='submit' value='MODIFICAR UNA NOTICIA' />
					<input type='hidden' name='volver' value=1 />
				</form>";
	global $titulo;
	$titulo = "BORRAR NOTICIAS";
