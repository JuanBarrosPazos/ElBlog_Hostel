<?php
	...
	$sqltipo =  "SELECT * FROM `$db_name`.`gch_tipologia` WHERE `gch_tipologia`.`tipo` = '$vtipo'";
	...
	$sqlreftipo =  "SELECT * FROM `$db_name`.`gch_tipologia` WHERE `gch_tipologia`.`reftipo` = '$vreftipo'";
