...
function espec_borra(){
	...
	$sqld2 = "UPDATE `$db_name`.`gch_art` SET `refespec1` = 'otrs' WHERE `gch_art`.`refespec1` = '$_POST[refespec]' ";
	if(mysqli_query($db, $sqld2)){}
	else {print("NO SE HAN ACTUALIZADO LAS ENTRADAS EN gch_art => refespec1 => otrs en ".$_POST['refespec']."* MODIFIQUE LA ENTRADA L.61: ".mysqli_error($db));}

	$sqld3 = "UPDATE `$db_name`.`gch_art` SET `refespec2` = 'otrs' WHERE `gch_art`.`refespec2` = '$_POST[refespec]' ";
	if(mysqli_query($db, $sqld3)){}
	else {print("NO SE HAN ACTUALIZADO LAS ENTRADAS EN gch_art => refespec2 => otrs en ".$_POST['refespec']."* MODIFIQUE LA ENTRADA L.65: ".mysqli_error($db));}
