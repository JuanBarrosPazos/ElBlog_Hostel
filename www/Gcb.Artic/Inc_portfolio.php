...
function process_form(){
    ...
    if ((isset($_GET['portfolio'])) || (isset($_POST['portfolio']))) {
        ...
        elseif (isset($_GET['portfolio'])){
           ...
           global $sqla;
          $sqla =  " SELECT * FROM `$db_name`.`gcb_art` WHERE `refart` = '$refrest' LIMIT 1 ";
         //echo "TENEMOS DATOS GET".$_GET['portfolio'];
                        }
    else {  global $sqla;
            $sqla=  "SELECT * FROM `$db_name`.`gcb_art` ORDER BY `id` ASC LIMIT 1 ";
...
if(!$qa){ print("* ".mysqli_error($db)."</br>");
        ...
        while($rowb = mysqli_fetch_assoc($qa)){
            ...
            global $opina;
            $opina = "<form style=\"display: block; margin:0.4em 0em -4em 0em;\" name='creaopina' action='../Gcb.Syst/Opina_Cliente.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=440px, height=580px')\">
            ...
            $img1 = "<div class='protfolioimg'>
                        <img class='img-fluid' src='../Gcb.Img.Art/".$rowb['myimg1']."' alt=''>
                    </div>";
            global $img1b;
            $img1b = "<img class='img-fluid d-block mx-auto' src='../Gcb.Img.Art/".$rowb['myimg1']."' alt=''>";
            global $img2;
            $img2 = "<div class='protfolioimg'>
                        <img class='img-fluid' src='../Gcb.Img.Art/".$rowb['myimg2']."' alt=''>
                    </div>";
            global $img2b;
            $img2b = "<img class='img-fluid d-block mx-auto' src='../Gcb.Img.Art/".$rowb['myimg2']."' alt=''>";
            global $img3;
            $img3 = "<div class='protfolioimg'>
                        <img class='img-fluid' src='../Gcb.Img.Art/".$rowb['myimg3']."' alt=''>
                    </div>";
            global $img3b;
            $img3b = "<img class='img-fluid d-block mx-auto' src='../Gcb.Img.Art/".$rowb['myimg3']."' alt=''>";
            global $img4;
            $img4 = "<div class='protfolioimg'>
                        <img class='img-fluid' src='../Gcb.Img.Art/".$rowb['myimg4']."' alt=''>
                    </div>";
            global $img4b;
            $img4b = "<img class='img-fluid d-block mx-auto' src='../Gcb.Img.Art/".$rowb['myimg4']."' alt=''>";
