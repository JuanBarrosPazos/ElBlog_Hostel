...
function process_form(){
	...
	<img src='../Gcb.Img.Art/".$rowb['myimg1']."'  width='99%' height='auto' />
						</td>
	...
	<input name='Tlf2' type='hidden' value='".$rowb['Tlf2']."' />
        ...
        if ($pageb != 1) {
			echo '<div class="paginacion">
					<a href="Art_Borrar_01.php?pageb='.($pageb-1).'">
        ...
        for ($i=1;$i<=$total_pages;$i++) {
            if ($pageb == $i) {
				...
				echo '<div class="paginacion">
						<a href="Art_Borrar_01.php?pageb='.$i.'">'.$i.'</a>
					</div>';
            }
        }
...
function ver_todo(){
	...
	*/
    ...
    if ($total_pages > 1) {
        if ($page != 1) {
			echo '<div class="paginacion">
					<a href="Art_Borrar_01.php?page='.($page-1).'">
						<span aria-hidden="true">&laquo;</span>
					</a>
				</div>';
        }
        ...
        for ($i=1;$i<=$total_pages;$i++) {
            if ($page == $i) {
				...
				echo '<div class="paginacion">
						<a href="Art_Borrar_01.php?page='.$i.'">'.$i.'</a>
					</div>';
            }
        }
