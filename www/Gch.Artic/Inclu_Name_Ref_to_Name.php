<?php
	...
	$sqlisna=  "SELECT * FROM `gch_islas` WHERE `refisla` = '$isref'";
	...
	$sqlayna=  "SELECT * FROM `gch_aytos` WHERE `refayto` = '$ayref'";
	...
	$sqltip=  "SELECT * FROM `gch_tipologia` WHERE `reftipo` = '$tipref'";
	...
	$sqlespec1=  "SELECT * FROM `gch_especialidad` WHERE `refespec` = '$espec1ref'";
	...
	$sqlespec2=  "SELECT * FROM `gch_especialidad` WHERE `refespec` = '$espec2ref'";
