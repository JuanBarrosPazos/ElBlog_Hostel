...
// DEFINO LAS VALORACIONES Y LOS CALCULOS.
	...
	if(($valpunt == 0)||($num_val == 0)){	$valpunt = 0;
							...
							global $valmartx100;
							//$valmartx100 = 0;
							if (isset($_POST['valora'])){$valmartx100 = $_POST['valora'];}
							else {$valmartx100 = 50;}				
	} else {
		global $valx100;
	...
	if(($valpunt2 == 0)||($num_val == 0)){	$valpunt2 = 0;
								...
								global $valmart2x100;
								//$valmart2x100 = 0;
								if (isset($_POST['precio'])){ $valmart2x100 = $_POST['precio']; }
								else { $valmart2x100 = 50; }
											
	} else { global $val2x100;
			 $val2x100 = round((($valpunt2 * 100) / ($num_val * 5)), 0);
			 global $valmart2x100;
			 //$valmart2x100 = round((($valpunt2 * 100) / ($num_val * 5)), 0);
			 $valmart2x100 = $val2x100;
				}
