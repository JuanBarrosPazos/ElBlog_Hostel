...
function process_form(){
	...
	$sqlv = "DELETE FROM `$db_name`.`gch_opiniones` WHERE `gch_opiniones`.`refart` = '$_SESSION[refart]' ";
...
function deleteimg(){
	...
	global $ruta1;
	$ruta1 = "../Gch.Img.Art/".$_SESSION['myimg1'];
	...
	global $ruta2;
	$ruta2 = "../Gch.Img.Art/".$_SESSION['myimg2'];
	...
	global $ruta3;
	$ruta3 = "../Gch.Img.Art/".$_SESSION['myimg3'];
	...
	global $ruta4;
	$ruta4 = "../Gch.Img.Art/".$_SESSION['myimg4'];
