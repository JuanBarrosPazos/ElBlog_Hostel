...
<form style="display: inline-block;" name='veropina' action='../Gcb.Users/User_Crear.php' target='popup' method='POST' onsubmit="window.open('', 'popup', 'width=640px, height=680px')">
<input type='submit' value='REGISTRARME COMO USUARIO' />
      ...
      <div class="modal-body">
        ...
        ?>
          ...
          <img class="mb-4" src="../Gcb.Img.Sys/LogoBMoll.png" alt="" width="40%" height="40%">
