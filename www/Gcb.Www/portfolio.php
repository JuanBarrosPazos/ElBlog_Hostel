...
function MM_validateForm() { 
  ...
  <?php 
      ...
      require '../Gcb.Artic/Inc_portfolio.php';
  ...
  <section class="bg-light page-section" id="portfolio">
          ...
          <h3 class="section-subheading text-muted">
              ...
              echo $especialidades.$islaname." / ".$aytoname."<br>
                  ...
                  <div class=\"progresa\">
                    ...
                    <img class=\"star2\" src='../Gcb.Img.Sys/5Star.png' />
                  </div>
                  <br>
    ...
    // LLAMO AL FORMULARIO DE CONTACTO
      ...
      require '../Gcb.Artic/Inc_portfolio_mail_form.php';
    ...
    <?php
     ...
     // DEFINO LAS OPINIONES QUE ESTAN VALIDADAS OK POR EL ADMINISTRADOR
        ...
        //echo "******** ".$refartop;
        $sqlop =  "SELECT * FROM `$db_name`.`gcb_opiniones` WHERE `refart` = '$refartop' AND `modera` = 'y' ORDER BY `id` DESC ";
