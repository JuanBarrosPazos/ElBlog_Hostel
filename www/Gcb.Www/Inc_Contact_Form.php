...
<div class=\"row\">
  ...
  <h4 class=\"section-heading text-uppercase\" style=\"text-align: center; margin: -1.6em 0em 0.3em 0em;\">
    ...
    <div class=\"juancentramail\">
        ...
        <div style=\"display: block;\">
            <input name='asunto' id='asunto' type='text' size='36' maxlength='35' placeholder=\"&nbsp;ASUNTO\" value='".$defaults['asunto']."'/>
        </div>
        ...
        <div style=\"display: block;\">
<textarea onkeypress='return limita(event, 200)' onkeyup='actualizaInfo(200)' name='mensaje' id='mensaje' cols='40' rows='5' placeholder=\"&nbsp;SU CONSULTA\">".$defaults['mensaje']."</textarea>
       </div>
