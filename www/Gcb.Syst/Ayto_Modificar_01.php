...
function ayto_borra(){
	...
	// BORRO LOS ARTICULOS
	$sqld2 = "DELETE FROM `$db_name`.`gcb_art` WHERE `gcb_art`.`refayto` = '$_POST[refayto]' ";
	if(mysqli_query($db, $sqld2)){}
	else {print("NO SE HAN BORRADO LOS DATOS EN gcb_art ".$_POST['refayto']."* MODIFIQUE LA ENTRADA L.108: ".mysqli_error($db));}
