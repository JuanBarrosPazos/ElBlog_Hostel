...
function process_form(){
	...
	$sqld = "UPDATE `$db_name`.`gcb_art` SET `refespec1` = '$vrefespec' WHERE `gcb_art`.`refespec1` = '$_SESSION[refespec]' ";
	if(mysqli_query($db, $sqld)){}
	else{echo "NO SE HAN ACTUALIZADO LAS ENTRADAS EN gcb_art => refespec1 => ".$vrefespec."<br> * MODIFIQUE LA ENTRADA L.68: ".mysqli_error($db);}

	$sqld2 = "UPDATE `$db_name`.`gcb_art` SET `refespec2` = '$vrefespec' WHERE `gcb_art`.`refespec2` = '$_SESSION[refespec]' ";
	if(mysqli_query($db, $sqld2)){}
	else{echo "NO SE HAN ACTUALIZADO LAS ENTRADAS EN gcb_art => refespec2 => ".$vrefespec."<br> * MODIFIQUE LA ENTRADA L.72: ".mysqli_error($db);}
