...
session_start();
	...
	<!--
	<form name='creaopina' action='Gcb.Syst/Opina_Cliente.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=520px, height=600px')\">
	<form name='creaopina' action='Gcb.Syst/Opina_Cliente.php' method='POST'>
...
require '../Gcb.Users/Inc_Footer.php';
