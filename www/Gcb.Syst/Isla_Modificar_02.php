...
function process_form(){
	...
	$sqld = "UPDATE `$db_name`.`gcb_art` SET `refisla` = '$vrefisla' WHERE `gcb_art`.`refisla` = '$_SESSION[refisla]' ";
	if(mysqli_query($db, $sqld)){}
	else{echo "NO SE HAN ACTUALIZADO LAS ENTRADAS EN gcb_art ".$vrefisla."<br> * MODIFIQUE LA ENTRADA L.89: ".mysqli_error($db);}
