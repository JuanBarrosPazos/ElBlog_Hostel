<?php
	...
	$sqlespec =  "SELECT * FROM `$db_name`.`gcb_especialidad` WHERE `gcb_especialidad`.`espec` = '$vespec'";
	...
	$sqlrefespec =  "SELECT * FROM `$db_name`.`gcb_especialidad` WHERE `gcb_especialidad`.`refespec` = '$vrefespec'";
