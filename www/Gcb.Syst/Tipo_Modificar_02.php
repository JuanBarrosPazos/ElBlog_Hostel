...
function process_form(){
	...
	$sqld = "UPDATE `$db_name`.`gcb_art` SET `reftipo` = '$vreftipo' WHERE `gcb_art`.`reftipo` = '$_SESSION[reftipo]' ";
	if(mysqli_query($db, $sqld)){}
	else{echo "NO SE HAN ACTUALIZADO LAS ENTRADAS EN gcb_art ".$vreftipo."<br> * MODIFIQUE LA ENTRADA L.89: ".mysqli_error($db);}
