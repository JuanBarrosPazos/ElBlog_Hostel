...
function tipo_borra(){
	...
	$sqld2 = "UPDATE `$db_name`.`gcb_art` SET `reftipo` = 'otrs' WHERE `gcb_art`.`reftipo` = '$_POST[reftipo]' ";
	if(mysqli_query($db, $sqld2)){}
	else {print("NO SE HAN ACTUALIZADO LAS ENTRADAS EN gcb_art ".$_POST['reftipo']."* MODIFIQUE LA ENTRADA L.61: ".mysqli_error($db));}
