...
function process_form(){
	...
	$sqld = "UPDATE `$db_name`.`gcb_art` SET `refayto` = '$vrefayto', `refisla` = '$visla' WHERE `gcb_art`.`refayto` = '$_SESSION[refayto]' ";
	if(mysqli_query($db, $sqld)){}
	else{echo "NO SE HAN ACTUALIZADO LAS ENTRADAS EN gcb_art ".$vrefayto."<br> * MODIFIQUE LA ENTRADA L.71: ".mysqli_error($db);}
