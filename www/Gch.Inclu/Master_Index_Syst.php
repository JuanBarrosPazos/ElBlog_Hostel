	...
	<li>
		<a href='#'><i class='ic ico13'></i> <span>ADMIN</span></a>
			<ul class='nav-flyout'>
				...
				<li>
					<a href='../Gch.Admin/Admin_Ver.php'><i class='ic ico15b'></i>CONSULTAR</a>
				</li>
				<li>
					<a href='../Gch.Admin/Admin_Crear.php'><i class='ic ico14b'></i>CREAR</a>
				</li>
				<li>
					<a href='../Gch.Admin/Admin_Modificar_01.php'><i class='ic ico02b'></i>MODIFICAR</a>
				</li>
				<li>
					<a href='../Gch.Admin/Admin_Borrar_01.php'><i class='ic ico19b'></i>BORRAR</a>
				</li>
