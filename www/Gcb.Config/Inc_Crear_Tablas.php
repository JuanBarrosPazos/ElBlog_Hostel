<?php
  ...
  UNIQUE KEY `Usuario` (`Usuario`)
	...
	$user = "CREATE TABLE IF NOT EXISTS `$db_name`.`gcb_user` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `id` (`id`)
	...
	$islas = "CREATE TABLE IF NOT EXISTS `$db_name`.`gcb_islas` (
  ...
  UNIQUE KEY `id` (`id`)
	...
	$vi = "INSERT INTO `$db_name`.`gcb_islas` (`id`, `isla`, `refisla`) VALUES
	(1, 'Mallorca', 'mall'),
	(2, 'Menorca', 'menr'),
	(3, 'Ibiza', 'ibiz'),
	(4, 'Formentera', 'form')";
	...
	$aytos = "CREATE TABLE IF NOT EXISTS `$db_name`.`gcb_aytos` (
  `id` int(3) NOT NULL auto_increment,
  ...
  UNIQUE KEY `id` (`id`)
	...
	$vay = "INSERT INTO `$db_name`.`gcb_aytos` (`id`, `ayto`, `refayto`, `refisla`) VALUES
	...
	$tipologia = "CREATE TABLE IF NOT EXISTS `$db_name`.`gcb_tipologia` (
  ...
  UNIQUE KEY `id` (`id`)
	...
	$vi2 = "INSERT INTO `$db_name`.`gcb_tipologia` (`id`, `tipo`, `reftipo`) VALUES
	(1, 'Restaurante', 'rs01'),
	...
	$especialidad = "CREATE TABLE IF NOT EXISTS `$db_name`.`gcb_especialidad` (
  `id` int(2) NOT NULL auto_increment,
  ...
  UNIQUE KEY `refespec` (`refespec`)
	...
	$vi3 = "INSERT INTO `$db_name`.`gcb_especialidad` (`id`, `espec`, `refespec`) VALUES
