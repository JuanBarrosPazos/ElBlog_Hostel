...
print("
	...
	<li>
		...
		<li>
			<a href='../Gcb.Syst/Tipo_Modificar_01.php'>
				<i class='ic ico22'></i>CATEGORIA
			</a>
		</li>
		<li>
			<a href='../Gcb.Syst/Espec_Modificar_01.php'>
				<i class='ic ico22'></i>PLATOS
			</a>
		</li>
		<li>
			<a href='../Gcb.Syst/Isla_Modificar_01.php'>
				<i class='ic ico22'></i>ISLAS
			</a>
		</li>
		<li>
			<a href='../Gcb.Syst/Ayto_Modificar_01.php'>
	...
	<li>
		<a href='#'><i class='ic ico13'></i> <span>ADMIN</span></a>
			<ul class='nav-flyout'>
				...
				<li>
					<a href='../Gcb.Admin/Admin_Ver.php'>
						<i class='ic ico15b'></i>CONSULTAR
					</a>
				</li>
				<li>
					<a href='../Gcb.Admin/Admin_Crear.php'>
						<i class='ic ico14b'></i>CREAR
					</a>
				</li>
				<li>
					<a href='../Gcb.Admin/Admin_Modificar_01.php'>
						<i class='ic ico02b'></i>MODIFICAR
					</a>
				</li>
				<li>
					<a href='../Gcb.Admin/Admin_Borrar_01.php'>
	...
	<li>
		<a href='#'><i class='ic ico02'></i> <span>RESTAURANTES</span></a>
			<ul class='nav-flyout'>
				...
				<li>
					<a href='../Gcb.Syst/Opina_Modificar_01.php'>
