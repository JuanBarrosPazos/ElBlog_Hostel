...
<embed src='../Gch.audi/claves_lost_2.mp3' autostart='true' loop='false' width='0' height='0' hidden='true' >
</embed>");
...
function show_form($errors=''){
	...
	if ($errors){
		...
		print("<embed src='../Gch.audi/claves_lost_2.mp3' autostart='true' loop='false' width='0' height='0' hidden='true' >
				</embed>");
				}
...
function process_form(){
	...
	print ("<tr>
			...
			<tr>
				<td colspan=2 align='center'>
	<img src='../Gch.Img.Admin/".$rowc['myimg']."' height='60px' width='45px' />
				</td>
			</tr>
			<tr>
				<td colspan=2 align='center'>
		...
		# cabeceras
			...
			if( mail($destinatario, $titulo, $mensaje, $cabecera)){
						...
						print("<table align='center' style=\"margin-top:14px\">
							...
							<table>
		<embed src='../Gch.audi/claves_lost_3.mp3' autostart='true' loop='false' width='0' height='0' hidden='true' >
		</embed>
			");
			...
			print("<table align='center' style=\"margin-top:20px;margin-bottom:20px\">
					...
					<table>
		<embed src='../Gch.audi/claves_lost_4.mp3' autostart='true' loop='false' width='0' height='0' hidden='true' >
		</embed>");
