...
--
-- Volcado de datos para la tabla `gcb_art`
--

INSERT INTO `gcb_art` (`id`, `refuser`, `refart`, `tit`, `titsub`, `datein`, `timein`, `datemod`, `timemod`, `conte`, `myimg1`, `myimg2`, `myimg3`, `myimg4`, `refayto`, `refisla`, `reftipo`, `refespec1`, `refespec2`, `iprecio`, `ivalora`, `url`, `map`, `mapiframe`, `latitud`, `longitud`, `calle`, `Email`, `Tlf1`, `Tlf2`) VALUES
...
CREATE TABLE IF NOT EXISTS `gcb_aytos` (
...
INSERT INTO `gcb_aytos` (`id`, `ayto`, `refayto`, `refisla`) VALUES
...
CREATE TABLE IF NOT EXISTS `gcb_especialidad` (
...
INSERT INTO `gcb_especialidad` (`id`, `espec`, `refespec`) VALUES
...
CREATE TABLE IF NOT EXISTS `gcb_islas` (
	`id` int(3) NOT NULL auto_increment,
...
INSERT INTO `gcb_islas` (`id`, `isla`, `refisla`) VALUES
('1', 'Mallorca', 'mall'),
('2', 'Menorca', 'menr'),
('3', 'Ibiza', 'ibiz'),
('4', 'Formentera', 'form');
...
CREATE TABLE IF NOT EXISTS `gcb_opiniones` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
  `refart` varchar(22) CHARACTER SET utf8 COLLATE utf8_spanish2_ci NOT NULL,
...
INSERT INTO `gcb_opiniones` (`id`, `refart`, `refuser`, `refayto`, `refisla`, `opina`, `valora`, `precio`, `datein`, `datemod`, `modera`) VALUES
...
CREATE TABLE IF NOT EXISTS `gcb_tipologia` (
	`id` int(2) NOT NULL auto_increment,
...
INSERT INTO `gcb_tipologia` (`id`, `tipo`, `reftipo`) VALUES
('1', 'Restaurante', 'rs01'),
